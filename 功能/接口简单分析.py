...
class 分析辅助():
    ...
    def _添加主导建筑输入信息(self, 主导建筑: 建筑) -> None:
        ...
        l_连接建筑序号: 类型.Int32 = 输入接口.目标序号
        主导建筑.悠米_接口分析.添加分析(单接口分析(
            自身接口序号 = l_主导接口序号,
            目标接口序号 = l_被动接口序号,
            主导者 = 接口主导者.自身,
            连接方向 = 接口方向.目标流向自身,
            自身建筑 = 建筑预览.由建筑构造(主导建筑),
            连接建筑 = 建筑预览.由建筑构造(self.l_所有建筑[l_连接建筑序号]),
            起点建筑 = 建筑预览.空预览(),
            终点建筑 = 建筑预览.空预览(),
            连接类型 = 接口类型.未知,
        ))
    ...
    def _添加被动建筑输入信息(self, 主导建筑: 建筑) -> None:
        ...
        l_被动接口序号: 类型.Int8  = 输入接口.目标接口
        l_连接建筑序号: 类型.Int32 = 输入接口.目标序号
        被动建筑: 建筑 = self.l_所有建筑[l_连接建筑序号]
        被动建筑.悠米_接口分析.添加分析(单接口分析(
            自身接口序号 = l_被动接口序号,
            目标接口序号 = l_主导接口序号,
            主导者 = 接口主导者.目标,
            连接方向 = 接口方向.自身流向目标,
            自身建筑 = 建筑预览.由建筑构造(self.l_所有建筑[l_连接建筑序号]),
            连接建筑 = 建筑预览.由建筑构造(主导建筑),
            起点建筑 = 建筑预览.空预览(),
            终点建筑 = 建筑预览.空预览(),
            连接类型 = 接口类型.未知,
        ))
