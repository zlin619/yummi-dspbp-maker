...
for 本建筑 in 本蓝图.蓝图中段.建筑:
    if 本建筑.配方序号 == 配方("铁板"):
        ...
        本建筑.物品序号 = 图标("传送带")
    elif 本建筑.配方序号 == 配方("电路板"):
        本建筑.物品序号 = 图标("分拣器")
    elif 本建筑.配方序号 == 配方("分拣器"):
        本建筑.物品序号 = 图标("分拣器")
    elif 本建筑.模型序号 == 模型("卫星配电站"):
        本建筑.物品序号 = 图标("传送带")
    elif 本建筑.模型序号 == 模型("采矿机"):
        本建筑.物品序号 = 图标("传送带")
    elif 本建筑.模型序号 == 模型("大型采矿机"):
        本建筑.物品序号 = 图标("分拣器")
...
for i in range(3):
    石爪[i].输入接口.目标序号 = 石炉[i].建筑序号
    石爪[i].输入接口.目标接口 = 15
    钢爪[i].输入接口.目标序号 = 钢炉[i].建筑序号
    钢爪[i].输入接口.目标接口 = 15
