...
ns_100 = 638725880353110111
# 转换为秒
秒 = ns_100 / 1e7
print(秒)
# datetime用的是POSIX时间戳
# POSIX时间戳 是 1970年01月01日00时00分00秒 起至现在的总秒数
POSIX时间戳 = 秒 - 62135596800000
print(POSIX时间戳)  # 1677694280.353111
print(datetime.datetime.fromtimestamp(POSIX时间戳))
